...
#[get("/static/<filename>")]
fn static_files(filename: String) -> Result<Content<&'static [u8]>, String> {
    match filename.as_ref() {
        "technative.png" => Ok(Content(ContentType::PNG, include_bytes!("static/images/technative.png"))),
...
fn rocket() -> rocket::Rocket {
    rocket::ignite()
        .mount("/", routes![index, hello, about, static_files])
